object frmAppointmentPlanner: TfrmAppointmentPlanner
  Left = 0
  Top = 0
  Width = 845
  Height = 439
  ...
  object Planner1: TPlanner
    ...
    Display.ActiveEnd = 52
    Display.DisplayStart = 32
    Display.DisplayEnd = 79
    ...
    Items = <>
    Mode.Month = 1
    Mode.PeriodStartDay = 16
    Mode.PeriodStartMonth = 1
    Mode.PeriodStartYear = 2015
    Mode.PeriodEndDay = 5
    Mode.PeriodEndMonth = 3
    Mode.PeriodEndYear = 2015
    Mode.TimeLineStart = 42020.000000000000000000
  ...
  object adsAppointments: TAureliusDataset
    ...
    object adsAppointmentsFinalDate: TDateTimeField
      FieldName = 'FinalDate'
    end
  end
