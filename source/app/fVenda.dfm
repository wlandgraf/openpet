object fmVenda: TfmVenda
  Left = 0
  Top = 0
  ActiveControl = edPessoa
  Caption = 'Venda'
  ClientHeight = 405
  ClientWidth = 681
  Color = clBtnFace
  ...
  object ActionList1: TActionList
    Left = 144
    Top = 56
    object acNovoItem: TAction
      Caption = 'Incluir'
      ShortCut = 16457
      OnExecute = acNovoItemExecute
      OnUpdate = acNovoItemUpdate
    end
    object acPagamento: TAction
      Caption = 'Pagamento'
    end
    object acFinalizar: TAction
      Caption = 'Finalizar'
      OnExecute = acFinalizarExecute
      OnUpdate = acFinalizarUpdate
    end
    object acRemover: TAction
      Caption = 'Remover item'
      OnExecute = acRemoverExecute
      OnUpdate = acRemoverUpdate
    end
    object acImportAppointments: TAction
      Caption = 'Importar Agendamentos'
      OnExecute = acImportAppointmentsExecute
    end
  end
  object tbItens: TAureliusDataset
    FieldDefs = <
      item
        Name = 'Self'
    ...
    OnObjectRemove = tbItensObjectRemove
    Left = 400
    Top = 208
    object tbItensSelf: TAureliusEntityField
      FieldName = 'Self'
      ReadOnly = True
    end
    object tbItensDesconto: TCurrencyField
      FieldName = 'Desconto'
      ReadOnly = True
      Required = True
    end
    ...
    object tbItensProduto: TAureliusEntityField
      FieldName = 'Produto'
      Required = True
    end
    object tbItensQtde: TIntegerField
      FieldName = 'Qtde'
      Required = True
    end
    object tbItensValorUnitario: TCurrencyField
      FieldName = 'ValorUnitario'
      Required = True
    end
    object tbItensValorFinal: TCurrencyField
      FieldName = 'ValorFinal'
      Required = True
    end
    object tbItensAnimal: TAureliusEntityField
      FieldName = 'Animal'
    end
    object tbItensProdutoDescricao: TStringField
      FieldName = 'Produto.Descricao'
      Size = 255
    end
    object tbItensAnimalNome: TStringField
      FieldName = 'Animal.Nome'
      Size = 255
    end
    object tbItensQtdeItem: TIntegerField
